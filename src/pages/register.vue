...
const register = async () => {
  try{
    const {data} = await userStore.signUp(signUpVariables.value);
    if (data.error) {
      return toast.value.showMessage(data.errorMessage, 'error')
    }
    toast.value.showMessage('Successfully registered', 'success')
        ...
        <VCardText>
          ...
          >
            <VRow>
              ...
              <VCol cols="12">
                <VTextField
                  v-model="signUpVariables.firstName"
              ...
              <VCol cols="12">
                <VTextField
                  v-model="signUpVariables.middleName"
                  :rules="[requiredValidator]"
                  label="Middle Name"
                />
              </VCol>
              ...
              <VCol cols="12">
                <VTextField
                  v-model="signUpVariables.lastName"
                  :rules="[requiredValidator]"
                  label="Last Name"
                />
              </VCol>
              ...
              <VCol cols="12">
                <VTextField
                  v-model="signUpVariables.username"
              ...
              <VCol cols="12">
                <VTextField
                  v-model="signUpVariables.password"
                  :rules="[requiredValidator]"
                  label="Password"
                ...
                <div class="d-flex align-center mt-1 mb-4">
                  <!-- <VCheckbox
                    id="privacy-policy"
                    v-model="signUpVariables.privacyPolicies"
                    :rules="[requiredValidator]"
                    inline
                  >
                    <template #label>
